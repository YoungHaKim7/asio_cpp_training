...
$ /opt/homebrew/opt/gcc@15/bin/g++-15 -std=c++2c -pedantic -pthread -pedantic-errors -lm -Wall -Wextra -ggdb -Werror -I /opt/homebrew/Cellar/asio/1.36.0/include -o ./target/a01_hello_asio ./src/main.cpp
clang: warning: overriding deployment version from '16.0' to '26.0' [-Woverriding-deployment-version]

./target/a01_hello_asio
Hello world Cpp 26 lang Hello, Asio⏎  
```
...
# asio 
include_asio := "-I /opt/homebrew/Cellar/asio/1.36.0/include"

# (C)gpp compile(LinuxOS)
r:
	rm -rf {{target_dir}}
	mkdir -p {{target_dir}}
	{{gpp_which}} {{ldflags_common}} {{include_asio}} -o {{target_dir}}/{{project_name}} {{source}}
	{{target}}
